const BlogData=[
    {
        ...
        para: `New Delhi: Indians are the third most frequent travellers in the Asia-Pacific region, with an average 7.6 flights a year, according to the Expedia Flight and Hotel Etiquette Survey 2018.
        ...
        The survey was conducted online across North America, Europe, South America and Asia-Pacific using an amalgamated group of best-in-class panels. The study covered 18,229 respondents.
        As many as 793 were from Indian cities like Delhi, Mumbai, Bengaluru, Hyderabad and Pune.
        The survey results pointed out that Indians were at the top spot -- with 59 per cent globally -- of those who often engage in a conversation when sitting next to someone they don't know. It revealed that 70 per cent Indian travellers also dread sitting next to someone who talk too much.
        Also, 32 per cent Indians find seat kicker/bumper/grabbers most annoying in a flight or at the airport, while 30 per cent indicated that audio insensitive passengers are also most annoying.
        ...
        "The findings are a testimony of the growth in traffic being experienced by the aviation industry as Indians are the third most frequent travellers in Asia-Pacific region, with average 7.6 flights per year after Thailand and Japan.
        "Indians are also increasing shifting to technology as 67 per cent Indians check-in online while 18 per cent check-in on mobile. The country stands second in number of people using the boarding pass on a mobile device (29 per cent) after Thailand," said Manmeet Ahluwalia, Marketing Head of Brand Expedia.
        He said the study highlights that there was a higher preference of booking the flight first followed by the hotel (37 per cent), while 36 per cent book a flight and hotel together as a package.
        "Only 15 per cent Indians are driven by the hotel properties as they book a hotel first followed by the flight," he said.
        Some other findings of the survey are that majority of Indians (79 per cent) prefer window seat. Also, 53 per cent of Indians recline their seats only when they are going to sleep, 48 per cent recline if it's a long flight (3 hours or more) and 23 per cent recline when the person in front of them does.`
    },
    
    {
        ...
        para: `San Francisco: Google is working on a Pinterest-like app called Keen that will let people collect and share ideas, links and resources.
        ...
        People make a "keen," which can be about any topic, whether it's baking delicious bread at home, getting into birding or researching typography.
        ...
        The Keen team worked in close collaboration with another team at Google called People and AI Research (PAIR), dedicated to human-centered machine learning systems.
        ...
        People can also follow keens that others have created, discovering thousands of hand-curated lists from the community and getting alerts when new things are added.
    ...
    },
    {
        ...
        para: `One positive side of the pandemic induced lockdowns is the freedom of working at locations of your choice. While many complained in the beginning of the series of lockdowns that inability to move around makes them unhappy, they later started working from remote places of their choices. All they needed was internet.
        EaseMyTrip.com compiles a list of 5 stunning destinations which provide the best remote working experience in the country:
        <p style="font-weight: 600;">Jibhi, Himachal Pradesh
        ...
        <p style="font-weight: 600;">Shillong, Meghalaya
        ...
        <p style="font-weight: 600;">Varkala, Kerala
        ...
        <p style="font-weight: 600;">Mussoorie, Uttrakhand
        ...
        <p style="font-weight: 600;">Masinagudi, Tamil Nadu
    ...
    },
    {
        ...
        para: `New Delhi: There's rarely a chance when fans don't encounter a fun banter between Kiara Advani and Shahid Kapoor whenever the 'Kabir Singh' actors write anything about each other on their social media space, and the same happened recently after Kiara praised the latter for his performance in 'Jersey'.
        ...
        Replying to Kiara for her kind words, Shahid re-shared her post on his Instagram handle and wrote, "My dearest Preeti your words will always stay in Kabirs heart Tu meri bandi hai," adding a pink heart emoticon.
        For the unversed, 'Jersey', which also stars Mrunal Thakur and Pankaj Kapur is helmed by Gowtam Tinnanuri.
    ...
    },
    {
        ...
        para: `New Delhi: Directed by Oscar-winning Taika Waititi, the film stars India's favorite Avenger Thor aka Chris Hemsworth along with a stellar ensemble cast: Tessa Thompson, Natalie Portman and Christian Bale who makes his MCU debut!
    ...
    },
    {
        ...
        The film headlined by Yash and starring a talented ensemble cast including Sanjay Dutt, Raveena Tandon and Srinidhi among others released nationwide on April 14, in Kannada, Telugu, Hindi, Tamil and Malayalam. 'KGF: Chapter 2' is written and directed by Prashanth Neel.
    ...
    },
    {
        ...
        para: `NEW DELHI: The leaked pictures of Katrina Kaif from her upcoming film 'Merry Christmas' co-starring Vijay Sethupathi, have come as a treat to her fans who were keeping on their toes to get a glimpse of the star's first look from the much-anticipated project. A slew of pictures featuring Katrina with Tamil actor Radikaa Sarathkumar from the sets of 'Merry Christmas' has been doing the rounds on social media.
        In the pictures, Katrina looks magnificent in a floral pink and white dress.
        On the other hand, Radhika can be seen dressed as a cop.For the unversed, on the occasion of 2021 Christmas, Katrina shared a photo with Vijay Sethupathi, director Sriram Raghavan to announce that she has started shooting for their upcoming film 'Merry Christmas'.
        ...
        Apart from this, Katrina will be seen in the third instalment of the 'Tiger' franchise, co-starring Salman Khan and Emraan Hashmi.
        She also has 'Jee Le Zara', co-starring Alia Bhatt and Priyanka Chopra; and horror-comedy 'Phone Bhoot' alongside Siddhant Chaturvedi and Ishaan Khatter in the pipeline.`
    },
    {
        id: 7,
        author: "Zee Media Bureau",
        ...
        para: `New Delhi: Rockstar Games, maker of the Grand Theft Auto V has revealed that the new versions of GTAV and GTA Online will be launched on March 15.
        GTA 5 new-gen version features new graphics modes including up to 4K resolution, a framerate of up to 60 frames per second, improved texture qualities, HDR options and ray tracing, faster loading times, immersive 3D audio, platform-specific features, and more.
        Rockstar Games has tweeted:
    ...
    },
    {
        ...
        para: `NEW DELHI: The third episode of 'Moon Knight' ended with Konshu being imprisoned in stone thanks to his manipulation of the night sky. Meanwhile, Marc and Steven are left without powers and without access to the Moon Knight suit.
    ...
    },
    {
        ...
        para: `Mumbai: The biographical sports drama 'Jhund', which stars Amitabh Bachchan in the lead, is set to debut on OTT on May 6. The film directed by 'Sairat' fame Nagraj Manjule, is based on the life of Vijay Barse; a real-life hero and founder of Slum Soccer, an organisation which works for the wellbeing and development of children from underprivileged backgrounds with an acumen to play football.
        The film stars Ankush Gedam, Akash Thosar, Rinku Rajguru and several other artistes, and brings to the fore the life of a slum dweller and his struggle to achieve his dream.
    ...
    },
    {
        ...
        para: `Washington: Priyanka Chopra-starrer "It's All Coming Back to Me" is all set to hit theatres on February 10, 2023. Initially titled 'Text For You', the film is based on the 2016 German film 'SMS fur Dich' by Karoline Herfurth, Variety reported.
        ...
        Apart from "It's All Coming Back to Me", Priyanka will also feature in the Russo Brother's 'Citadel' show.`
    },
    {
        id: 13,
        ...
        para: `Santa Monica is a city so rich in history, culture, and activity that there are tons of quirky facts about it that even locals might not know! Here’s a list of some of the more eccentric and less recognized information about beautiful, sunny Santa Monica.
        <p style="font-weight: 600;">Beach backstories
        ...
        <p style="font-weight: 600;">Eco-friendly facts
        ...
        <p style="font-weight: 600;">Tech Trivia
        ...
        <p style="font-weight: 600;">Architectural attractions
        ...
        <p style="font-weight: 600;">Undiscovered Talents
        ...
        <p style="font-weight: 600;">Famous Faces
        A number of notable people call Santa Monica their birth city. They include legendary child actress Shirley Temple, the funny man Jack Black, Academy Award winner Anjelica Huston, original Spider-Man Tobey Maguire and activist Jamie Lee Curtis.`
    },
    {
        id: 14,
        author: "Zee Media Bureau",
        ...
        para: `New Delhi: Samsung on Thursday launched a new M-series smartphone -- the Galaxy M12 with a 48MP quad-camera setup and a 90 Hz refresh rate display in the Indian market.
    ...
    },
    {
        ...
        para: `Mumbai: After ruling the box office for weeks, Alia Bhatt-starrer 'Gangubai Kathiawadi' is all set to release on Netflix now. On Wednesday, Netflix India took to Instagram and shared that its subscribers can watch 'Gangubai Kathiawadi' on the streamer from April 26 onwards.
        "Dekho, dekho chaand Netflix pe aaraha hai #GangubaiKathiawadi arriving on 26th April," the IG post read.
    ...
    },
    {
        ...
        para: `New Delhi: All the movie buffs, add Gerald Butler and Morena Baccarin’s starrer ‘Greenland’ to your watchlist. After the runaway global success of Gerald Butler's Greenland, the movie is all set to release in Hindi, Tamil and English exclusively on Lionsgate Play on 15th April, 2022, we decided to give you a small synopsis of the film.
        ...
        <b><i>Here are five reasons why you must watch Greenland this weekend:</i></b>
        ...
        <p style="color: red";>Gripping storyline
        ...
        <p style="color: red";>Adrenaline inducing action sequences
        ...
        <p style="color: red";>Emotional rollercoaster narrative
        ...
        <p style="color: red";>Alas, our favourite - Hopeful Ending!
    ...
    },
    {
        ...
        para: `New Delhi: 'Dunki' brings together two of the biggest forces in Indian cinema, filmmaker Rajkumar Hirani and superstar Shah Rukh Khan who will collaborate for the very first time.
    ...
    },
    {
        ...
        para: `Many of you must have heard this name but many have yet not. And also for those who have heard the term, many may not know what it actually means. Reverse Email Lookup actually indicates a process of using any program or application to find out information about a person just by using their email address. That must sound pretty interesting and impossible both at the same time.
        Reverse Email Lookup is a popular process used in multiple domains. It is mostly used by employers to find out real facts about people they wish to hire. After scrutinizing the CV, the employers usually use this process to find out facts about their employees. It’s a great way to gather factual information about anyone.
        On the other hand, reverse email lookup is also used as a popular security measure to verify someone before sharing any personal information with them. Many times, we get duped by fraud agencies to share our personal information in the name of gifting us something, claiming us as lucky winners of contests we never participated in, or offering us jobs. Before falling in the trap of any of these, one quick thing to do is just do a reverse email lookup of the address from where such mails came.
        Now that you have understood why to do an email lookup and how can it be beneficial for you, it is time to jump into the process of how to do it and have a glance at other details of this process.
        <b>How to Find Someone by Reverse Email Lookup?</b>
        There are multiple tools that can help you to conduct a reverse email lookup and achieve your objective. Each application or tool has its own setup for conducting a reverse email lookup. Some tools also let you find someone’s phone number. However, the core steps remain more or less the same for all of them.
        <b>Let us have a quick glance at how things are done for you to develop an overall idea:</b>
        <ul>
    ...
    },
    {
        ...
        para: `New Delhi: To loosen up and de-stress, millennials have understood that travelling is the best therapy. Utilising long weekends, Indians are exploring more offbeat locations rather than going to another city with the same hustle bustle, say experts.
    ...
    },
    {
        ...
        para: `Melbourne: Film studio Warner Bros says it has "complied" with Chinese censors to edit out specific references to a gay relationship in "Fantastic Beasts: The Secrets of Dumbledore", its latest theatrical release in the country.
        ...
        The company said they want the audiences, including in China, to enjoy the film.
        "We want audiences everywhere in the world to see and enjoy this film, and it's important to us that Chinese audiences have the opportunity to experience it as well, even with these minor edits," Warner Bros further said in the statement.
        ...
        The English author made the remarks following the publication of the seventh and final "Harry Potter" book, "The Deathly Hallows". Dumbledore was not explicitly gay in the book series.
        "The Secrets of Dumbledore" officially acknowledged the character's sexuality on screen for the first time.
        Previously, "Bohemian Rhapsody", the Freddie Mercury biopic, was famously chopped by Chinese censors, omitting all references to the Queen frontman's sexuality.
    ...
    },
    {
        ...
        para: `New Delhi: The Academy of Motion Picture Arts and Sciences has responded to actor Will Smith's resignation, saying that it has accepted the resignation and will "continue to move forward" with disciplinary proceedings against him.
        ...
        Smith, who won his first Oscar this year for 'King Richard', concluded, "Change takes time and I am committed to doing the work to ensure that I never again allow violence to overtake reason."The conflict arose after Rock, who was presenting the Oscar for Best Documentary Feature, seized the moment to crack a few jokes, including one about Smith's wife Jada Pinkett Smith's shaved head.
        He compared the 50-year-old actor's appearance to that of Demi Moore's look in 'G.I. Jane'.
        Jada, who recently opened up about living with alopecia areata, was visibly upset, rolling her eyes from her seat.Seconds later, Smith walked onstage and approached Rock, smacking him in front of the audience.
        ...
        When Smith won Best Actor later in the ceremony, he apologised to the Academy and his fellow nominees but didn't mention Rock by name.
        In his tearful speech, he spoke about acting out of love and protection, saying, "Love makes you do crazy things."
    ...
    },
    {
        ...
        para: `Sun, surf, mountains, and roller coasters: The Golden State is big and beautiful, whether you want to play at the beach, ride your way across California theme parks, or camp at one of California’s national parks. The state’s size and variety of offerings mean that a California family vacation will call for some solid preparation.
        ...
        <b>3. Maximize your time at the theme parks: </b>Staying at one of the on-site hotels can get you early entry—usually an hour earlier than the scheduled opening time—but sometimes just buying your tickets online (like at Universal Studios Hollywood) can get you an extra hour with shorter lines. Also, check the park’s website for express-lane services (like Disneyland Resort’s Fastpasses) so that you can make the most of your time all day.
        <b>4. Expect (some) admission discounts: </b>Kids and teens often get in free, or at a discount, at most museums and other attractions around the Golden State. San Diego has a "Kids Free October “program that is valid at many museums and other attractions, including SeaWorld and LEGOLAND. That said, don’t expect much of a break at other theme parks, or at other times. Full-price admission may start as low as age 10.
        <b>5. Measure your kids: </b>Before you commit to a theme park for the day, check out the rides page on its website to see the height minimums, to make sure there are enough rides that your children will be able to enjoy. Also, get the lay of the land from the theme park’s online map, to plot your day’s path efficiently and delay the onset of tired feet.
        <b>6. Book ahead for camping: </b>National parks such as Yosemite have well-established schedules for opening up campsites for reservations, and good spots can go fast—up to six months ahead of time. For last-minute spots, check a park’s campgrounds online to find availability.
    ...
    },
    {
        ...
        para: `Gurugram: "Good food is good food, no matter where you eat it -- as long as the flavours are right." These golden words were spoken by Australian celebrity chef Sarah Todd, and they perfectly describe the delicious spread available at The Wine Company.
        ...
        And true to her word, we did get a taste of what this Le Cordon Bleu-trained chef was talking about. We were first served the 'Frose', a frozen Rose wine slushie. It is a complimentary drink started exclusively by The Wine Company.
        ...
        "I don't go to restaurants for inspiration, I go to homes. Whenever I travel to India I only go to homes. I want to get the authentic flavours from home-cooked food and bring those influences in my menu," the young chef said while talking about creating a dish like the Goan pork Sausage bhut jolokia risotto.
    ...
    },
    {
        ...
        para: `Washington: A new trailer for Hollywood star Tom Cruise's much-anticipated movie Top Gun: Maverick has been unveiled on Tuesday and it shows the actor reviving his iconic role of Captain Pete Maverick Mitchell, now a high-flying test pilot and instructor. The film is a sequel to the 1986 hit movie Top Gun and has all the elements -- thrill, drama and action to keep the moviegoers glued to the screens.
        The sequel is set decades after the 1986 movie and features actor Miles Teller as the son of Anthony Edward's pilot Goose, who is killed during a training exercise in the first movie. The new trailer introduces viewers to the latest crop of the Navy's top pilots, with one of them even asking, "Everyone here is the best there is. Who the hell they're gonna get to teach us?"
        ...
        Top Gun: Maverick also stars Jennifer Connelly, Lewis Pullman, Charles Parnell, Jay Ellis, Jon Hamm, Ed Harris, Bashir Salahuddin, Danny Ramirez and Monica Barbaro. Joe Kosinski has directed the film, from a script by Peter Craig, Justin Marks and Eric Warren Singer.
    ...
    },
    {
        ...
        para: `New Delhi: Elon Musk says he has lined up $46.5 billion in financing to buy Twitter, and he's trying to negotiate an agreement with the   company. Last week, Musk announced an offer to buy the social media company for $54.20 per share, or about $43 billion. At the time, he did say how he would finance the acquisition.
        ...
        But Musk hasn't decided yet whether to do that.The documents say Twitter has not responded to Musk's proposal.Last week, Twitter's board adopted a “poison pill” defence that could make a takeover attempt prohibitively expensive.
    ...
    },
    {
        ...
        According to Yusuf Ibrahim, Alia's security in-charge, the team has been asked to provide protection for four-five days. "The wedding is indeed happening? The families have started arriving," Ibrahim told PTI without getting into any more details.
        The speculation is that the wedding might happen on Thursday.
        For reporters and photographers tasked with covering the star wedding, the last several days have been akin to piecing together a jigsaw - white curtains used as screens on windows, celeb designer Sabyasachi Mukherjee branded bags going in, stray comments from family and studied silence from Alia and Ranbir.
        Reporters stationed outside the building spotted Neetu Kapoor as well as her daughter Riddhima Kapoor Sahni and granddaughter Samara who arrived together. Ranbir's cousins, actors Kareena Kapoor Khan and Karisma Kapoor, and Aadar and Armaan Jain along with their mother Rima Jain reached shortly after.
        ...
        The video ends with a message from the team of "Brahmastra" wishing the couple "all the love and light". Johar, who has produced "Brahmastra" via Dharma Productions, shared the same teaser on his Instagram page.
        ...
        Neetu Kapoor, on her part, went down memory lane about her own engagement to her late husband and veteran actor Rishi Kapoor. "Fond memories of baisakhi day as we got engaged 43 years back on 13th April 1979," the veteran actor wrote on Instagram.
    ...
    },
    {
        ...
        para: `New Delhi: Sony India has expanded its Alpha 7R series full-frame mirrorless camera line-up by launching the Alpha 7R IV.
    ...
    },
    {
        ...
        para: `New Delhi: It is that time of the year when the chants of 'Jai Shri Krishna' reverberate all around you. The festive spirit of Shri Krishna Janmashtami has gripped one and sundry as it is widely celebrated not just in the country but across the globe. Devotees observe fast, sing his songs and pray to the god with much gusto. The day is also special as several delicacies are prepared at home for celebrating the birth of Thakur Ji.
        ...
        <p style="color: red; font-weight: 600;">Here's how you can make the yummy coconut burfi at home:
        <b>Ingredients:</b>
        <pre>
    ...
    },
    {
        ...
        para: `Los Angeles: 'The Batman' director Matt Reeves released a deleted scene from his superhero film featuring Robert Pattinson's Caped Crusader facing off against his classic nemesis, the Joker, played by Barry Keoghan.
        The scene is available after visiting a website that mimics the word puzzles posed by the Riddler (Paul Dano) in the movie, reports 'Variety'.
        As Reeves explained to 'Variety' in an interview in February, the scene follows Batman's discovery that the Riddler has killed the Gotham City police commissioner, leaving behind another of his cryptic notes addressed to Batman.
        Unnerved by the Riddler's interest in him, Batman decides to seek out insight into what makes the Riddler tick.
        ...
        Reeves shared: "You realise that they have a relationship, and that this guy obviously did something, and Batman somehow got him into Arkham."
        ...
        "Maybe he's a fan of yours?" Joker says.
        "Or maybe he's got a grudge against you, too. Maybe you're the main course."
    ...
    },
    {
        ...
        para: `New Delhi: As part of its "Yoga S940" series, Chinese technology company Lenovo on Wednesday launched new models of ultra-slim PCs in India along with an all-in-one desktop called "Yoga A940".
    ...
    },
    {
        ...
        para: `New Delhi: Selecting your next destination isnt easy and spending the month of June and July at home can never be treated as an experience. But then a beach trip can always be your escape! Right? Ditch the hills and snow when you can head out for a beach holiday.
    ...
    },
    {
        ...
        para: `New Delhi: Actors Vineet Kumar Singh, Akshay Oberoi and Urvashi Rautela starrer  'Dil Hai Gray'  is all set to hit the theatres in July 2022. The Susi Ganeshan directorial has its first look poster reveal scheduled on 14th April.
    ...
    },
    {
        ...
        The telecom organisation noted that the message falsely claims that the Government has promised 100 million users free recharge plans for online education. “It encourages people to click on a link to avail the free offer,” COAI added in its statement.
        ...
        The industry body further urged users to break the chain by not forwarding these messages to any of their friends or relatives. “By simply deleting and not forwarding such message, we can together fight this menace and save others from getting cheated,” it added in its statement.`
    },
    {
        id: 36,
        author: "Tahira Khan",
        ...
        para: `Los Angeles: 'The Batman' landed a bigger opening weekend than Warner Bros., the studio behind the comic book adventure, initially expected. The newest superhero epic, starring Robert Pattinson as an exceptionally moody Caped Crusader, collected $134 million in North American theatres over the weekend, above Sunday's estimates of $128.5 million.
    ...
    },
    {
        ...
        <b>The fit for king Kuttu Atta ki Puri</b>
        ...
        <b>The tranquillizing Aaloo ki Kadhi</b>
        ...
        <b>The titillating Singhade ke aate Ke Pakore</b>
    ...
    },
    {
        ...
        para: `Nainital is one of the most popular hill stations that people love to visit during vacations. While there are many things to do in this beautiful place, chances are that you might have struggled in deciding the activities that are best done here.
        Following are five things that you can do while you're in Nainital:
        <b>Visit the Naina Devi Temple</b>
        ...
        <b>Go Shopping at the mall road</b>
    ...
    },
    {
        ...
        para: `New Delhi: Ditch your everyday lime soda and drinks with sugar-loaded syrups. Try out innovative summer coolers with fruits like phalsa, watermelon and basil, suggest expert chefs.
    ...
    },
    {
        ...
        para: `Beijing: Xiaomi has launched its latest flagship smartphone the Mi 11 in China.
    ...
    },
    {
        ...
        para: `London: In not-so-good news for coffee drinkers in India as it is not ranked among the top 20 coffee drinking countries of the world, according to a survey.
        ...
        India, which did not figure in the top 20, is the seventh largest exporter of coffee. Most of its production is done in the southern part of the country.It exports 767 million pounds of coffee to different countries every year, accounting for over four percent of world coffee production.
        Croatia, which is ranked 19th, consumes 4.9 kg per capita of coffee a year.
        Its fabled coffee culture means the country ranks as one of the biggest caffeine fans globally, beating the United Kingdom and the United States into the top 20, according to Time Out Croatia.
    ...
    },
    {
        ...
        para: `If you think only long lost pieces of land, dense forests and hills are the places where the supernatural exists, think again! Even a metropolitan city like Delhi, with all its hustle-bustle, has places that are believed to be haunted.
        Scared? Well, the games have just begun!
        Check out these places in Delhi which are believed to be haunted.
        <b>Feroz Shah Kotla Fort</b>
    ...
    },
    {
        ...
        para: `Hyderabad: 'Arjun Reddy' fame Vijay Deverakonda's debut pan-India movie 'Liger' also marks boxing legend Mike Tyson's debut in Indian cinema. As the former professional boxer had wrapped up the shooting earlier, he has now completed dubbing his part for the movie.
        As the same information was updated by the producers of 'Liger', they had released a short video in which Tyson can be seen working on the dubbing part. "Thank you very much for being kind to me. I'm very grateful," said Mike Tyson in the video, as he wraps up the dubbing for his role.
        Pan-India star Vijay Deverakonda's highly anticipated film 'Liger' was done with its shooting part and post-production work is presently underway.
        ...
        Being made in Hindi, Telugu, Tamil, Kannada, and Malayalam, the movie is scheduled for release in theatres worldwide on August 25.`
    },
    {
        id: 44,
        author: "IANS",
        ...
        para: `New Delhi: A simple bowl or plate of noodles can be had in interesting and fun ways. To make them taste better, there are a lot of options like adding lemon zest, blended tomato or nuts, suggest experts.
    ...
    },
    {
        ...
        readTime: "1 min read",
        tags: ['Film', 'Hollywood'],
        para: `MUMBAI: Actor-filmmaker Kenneth Branagh's 'Death on the Nile' is set to release theatrically in India on February 11, the makers announced on Friday.
        The mystery-thriller is based on the 1937 Agatha Christie novel of the same name. The film is Branagh's follow-up to his 2017 blockbuster "The Murder on the Orient Express".
        ...
        "One of them is the murderer, find out who! Watch #DeathOnTheNile in cinemas, February 11 in English and Hindi," the post read. Branagh returns as director and reprises his role of detective Hercule Poirot.
    ...
    },
    {
        ...
        para: `New Delhi: Video game commerce giant Xsolla has unveiled Xsolla Web Shop stating that game developers can expect up to 40% revenue growth and the resources to reach players in newer geographies previously unavailable to them.
    ...
    },
    {
        ...
        para: `New Delhi: He has been named the ‘Hottest Chef of America’ by People magazine and has won a Michelin star for his restaurant in New York, but Chef Vikas Khanna's roots remain in India -- and he now wants to take the country's regional cuisines to the world.
        ...
        Talking about his love for regional cuisines, nothing can be more exciting for him than discovering the hidden recipes of the eight north-eastern states.
        ...
        On his many trips to the northeast he encountered several techniques that cannot be performed in a modern kitchen.
        "I have found how, in places where there is no refrigeration, people are preserving food. For instance, take spinach, add garlic, wrap it in a banana leaf and bury it under the ground. It'll virtually be fresh for ever. The whole of the northeast is home to such natural culinary tricks," he pointed out.
        His love for regional recipes is evident from ‘Utsav’, a magnum opus of 1,200 pages that covers the length and the breadth of the country. The book, which took 12 years to compile, also explores the festivals, ceremonies and rituals that symbolise India.
        ...
        Everything else apart, he is also working on a new book.
        "My new book, 'My First Kitchen', is going to be released soon. It is a massive book on how to run your kitchen, how to do parties in your kitchen, how to make cocktails and mocktails, and how to be very , very conscious about your cooking," Khanna said.`
    },
    {
        id: 48,
        author: "IANS",
        ...
        para: `Panaji: Plastic garbage converted into flotation devices, seaweed strewn on beaches broken down into compost and art installations fabricated from bottle caps and straws littered on Goa's beaches are the showstoppers of a 150-day-old beach cleanliness campaign in Goa.
        ...
        "The second component is we are converting all the plastic that is coming through the beaches to create swim zones. We are using plastic to create flotation devices. They are then going to be put back into the water to create swim zones. These are the two components which we are presently working on," he added.`
    },
    {
        id: 49,
        author: "Pankaj Nath",
        ...
        para: `New Delhi: In today's world we have to be fit and healthy in order to cope with the ever-mounting pressures of a globalised life. Exercising in the gym and gardening alone won't keep you fit. You are what you eat and it is imperative you consume healthy foods.
        ...
        <b>Salmon:</b>
        Salmon is an excellent source of vitamins and Omega 3 fatty acids which are believed to keep your heart healthy. It is also high in protein.`
    }
]
